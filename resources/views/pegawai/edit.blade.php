    ...
    <section class="p-4 bg-white rounded-lg min-h-[50vh]">
        <div class="mx-auto max-w-screen-md">
            ...
            <div class="flex justify-between items-center mb-6">
                <h1 class="text-3xl font-bold text-[#C0392B]">Edit Pegawai</h1>
            ...
            {{-- FORM EDIT --}}
            {{-- Perhatikan action-nya mengarah ke route update dengan ID pegawai --}}
            <form action="{{ route('pegawai.update', $pegawai->id) }}" method="POST">
                ...
                <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
                    ...
                    <div class="sm:col-span-2">
                        ...
                        <input type="text" name="nama" id="nama" 
                            ...
                            value="{{ old('nama', $pegawai->nama) }}" required> {{-- Value ambil dari data lama --}}
                        @error('nama')
                ...
                {{-- TOMBOL SIMPAN --}}
                <button type="submit" class="mt-6 text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">
                    Simpan Perubahan
                </button>
            </form>
